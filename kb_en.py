...
TRAIT_EN = {
    ...
    "ridge": {
        "title": "Ridge Locus (FGF3-FGF4-FGF19 duplication) — Dorsal Ridge",
    ...
    "hairless": {
        "title": "Hairless Locus (FOXI3) — Hairlessness",
    ...
    "roan": {
        "title": "Roan Locus — Roan (Mixed Spotting)",
    ...
    "ticking": {
        "title": "T Locus — Ticking (Speckling)",
