...
DISEASE_CATEGORIES = [
    ...
    ("🧠 神経・脳系",     ["脳症", "リポフスチン", "運動失調", "脊髄小脳", "多剤耐性", "ガングリオシドーシス", "変性性脊髄症", "筋強直症", "小脳皮質", "感覚性神経", "ジストロフィー", "白質ジストロフィー", "Krabbe", "多発性神経", "発作性失神", "ヒドロキシグルタル", "髄膜脳炎", "ラフォラ", "ナルコレプシー", "神経軸索", "海綿状白質", "てんかん", "アレキサンダー病", "フコシドーシス", "マンノシドーシス", "ラゴット蓄積症", "発作性運動異常症", "歯・骨格・網膜", "小脳失調", "小脳低形成", "髄鞘形成不全", "脱髄性多発神経炎", "喉頭麻痺", "新生子小脳", "シェイキングパピー", "ハスキー脳症", "末端自咬", "ピルビン酸脱水素", "アシル CoA", "コハク酸セミアルデヒド", "多系統変性", "繊毛運動不全", "木質性膜炎"]),
    ("👁 眼科系",         ["緑内障", "夜盲", "コリーアイ", "白内障", "全色盲", "錐体杆体", "進行性網膜萎縮", "PRA", "多巣性網膜症", "CMR", "錐体ジストロフィー", "スターガルト", "rcd", "水晶体脱臼", "角膜", "ドライアイ", "小眼球", "網膜異形成", "難聴・前庭", "難聴 + 前庭", "両側性難聴", "成犬発症難聴", "片側性難聴"]),
    ...
    ("🧪 代謝・内分泌系", ["尿酸尿", "コバラミン", "グリコーゲン蓄積", "ムコ多糖", "銅蓄積", "高リン血症", "リン血症", "ポンペ病", "高シュウ酸尿", "尿酸結石", "キサンチン", "ジヒドロキシアデニン", "甲状腺機能", "ビタミン D", "アルカリホスファターゼ", "炎症性ミオパチー", "ALT 活性", "腸管脂質吸収不良", "脂質吸収", "無汗性外胚葉", "中鎖アシル", "低カタラーゼ"]),
    ("💪 筋・運動系",     ["運動誘発性", "中心核ミオパチー", "肢帯型筋", "重症筋無力症", "骨格異形成", "筋ジストロフィー", "ネマリン", "ミオパチー", "マスラディン", "胎児発症型", "新生子神経軸索", "ブリーウィペット", "悪性高熱症", "ジストログリカン", "マラミュート多発神経炎"]),
